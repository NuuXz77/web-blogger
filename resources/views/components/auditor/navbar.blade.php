    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <!-- Logo -->
                <a href="{{ route('auditor.dashboard') }}" class="text-xl font-bold flex items-center lg:ml-2.5">
                    ...
                    <span class="self-center text-gray-900">
                        Web Blogger <span class="text-primary">Auditor</span>
                    </span>
                </a>
            </div>
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            <ul class="py-1" role="none">
                                <li>
                                    <a href="{{ route('profile') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition duration-150" role="menuitem">
                                ...
                                <li>
                                    <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition duration-150" role="menuitem">
                                        <svg class="w-4 h-4 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
