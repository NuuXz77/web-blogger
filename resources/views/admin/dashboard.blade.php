        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
            ...
            <div class="p-6">
                <div class="text-center py-8">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Mulai dengan membuat artikel baru atau mengelola komentar.</p>
                    <div class="mt-6">
                        <a href="{{ route('admin.posts.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
