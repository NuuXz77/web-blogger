            ...
            <div class="flex-1">
                <div class="max-w-5xl">
                    <x-slot:header>
                        ...
                        {{-- <div>
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Edit Kunjungan Audit</h1>
                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div>
                                <h2 class="text-xl font-semibold leading-tight text-gray-800">
                                    Edit Kunjungan Audit
                                </h2>
                                <p class="text-sm text-gray-500 mt-1">
                                    Perbarui informasi kunjungan audit.
                                </p>
                            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border overflow-hidden mt-6">
                        <form action="{{ route('admin.audit.update', $audit) }}" method="POST" class="space-y-6">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="space-y-6">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <select name="status" id="status"
                                                ...
                                                <option value="konfirmasi"
                                                    {{ old('status', $audit->status) == 'konfirmasi' ? 'selected' : '' }}>
                                                    Konfirmasi
                                                </option>
                                                <option value="selesai"
                                                    {{ old('status', $audit->status) == 'selesai' ? 'selected' : '' }}>
                                                    Selesai
                                                </option>
                                            </select>
                                            @error('status')
                                    ...
                                    <div class="flex items-start space-x-4">
                                        ...
                                        <div class="flex-1">
                                            <label for="alamat"
                                                class="block text-sm font-medium text-gray-700 mb-2">
                                                Alamat Lengkap yang Akan Dikunjungi <span class="text-red-500">*</span>
                                            </label>
                                            <textarea name="alamat" id="alamat" rows="4" required
                                                placeholder="Masukkan alamat lengkap yang akan dikunjungi auditor"
                                                class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-primary focus:border-transparent transition-colors">{{ old('alamat', $audit->alamat) }}</textarea>
                                            @error('alamat')
                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                            @enderror
                                        </div>
