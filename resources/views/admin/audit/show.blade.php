                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <a href="{{ route('admin.audit.edit', $audit) }}"
                                    class="bg-primary text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2 text-sm">
                                        ...
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="mt-3 space-y-2">
                                                    <div>
                                                        <span class="text-xs font-medium text-orange-800">Alasan:</span>
                                                        <p class="text-sm text-orange-700">{{ $audit->reschedule_reason }}</p>
                                                    </div>
                                                    
                                                    @if($audit->preferred_date)
                                                        <div>
                                                            <span class="text-xs font-medium text-orange-800">Tanggal Preferensi:</span>
                                                            <p class="text-sm text-orange-700">{{ \Carbon\Carbon::parse($audit->preferred_date)->format('d F Y') }}</p>
                                                        </div>
                                                    @endif
                                                    
                                                    @if($audit->preferred_time)
                                                        <div>
                                                            <span class="text-xs font-medium text-orange-800">Waktu Preferensi:</span>
                                                            <p class="text-sm text-orange-700">{{ $audit->preferred_time }}</p>
                                                        </div>
                                                    @endif
                                                </div>
                                    ...
                                    <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-green-700 mt-1">Author telah mengkonfirmasi jadwal pada {{ $audit->author_confirmed_at->format('d M Y, H:i') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div>
                                                <h4 class="text-sm font-medium text-yellow-900">Menunggu Konfirmasi</h4>
                                                <p class="text-sm text-yellow-700 mt-1">Author belum mengkonfirmasi jadwal audit</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if($audit->rejection_reason)
                                    <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div>
                                                <h4 class="text-sm font-medium text-red-900">Permintaan Reschedule Ditolak</h4>
                                                <p class="text-sm text-red-700 mt-1">{{ $audit->rejection_reason }}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
