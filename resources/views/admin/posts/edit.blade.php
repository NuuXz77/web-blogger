    ...
    <x-slot:header>
        <div class="flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">
                {{ __('Edit Postingan') }}: {{ Str::limit($post->title, 50) }}
            </h2>
            <div class="flex space-x-2">
                <a href="{{ route('admin.posts.show', $post) }}" class="inline-flex items-center px-4 py-2 bg-gray-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-600 focus:bg-gray-600 active:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input 
                                        ...
                                        placeholder="Masukkan judul yang menarik untuk postingan Anda"
                                        required
                                    >
...
Anda dapat mengubah paragraf, menambahkan bagian baru, memperbarui daftar, kutipan, dan memformat konten sesuai kebutuhan. Ini akan menjadi badan utama dari postingan blog Anda yang akan dilihat pembaca."
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea 
                                    ...
                                    placeholder="Ringkasan singkat dari postingan... Ini akan muncul di pratinjau postingan dan hasil pencarian."
                            ...
                            <p class="mt-1 text-xs text-gray-500 flex items-center">
                                ...
                                Biarkan kosong untuk dibuat secara otomatis dari konten. Digunakan dalam pratinjau postingan dan deskripsi meta
                            </p>
                            @error('excerpt')
                                <p class="mt-2 flex items-center text-sm text-red-600">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="space-y-6">
                        ...
                        <div class="mb-4 p-3 bg-gray-50 rounded-md">
                            ...
                            @if($post->published_at)
                                <p class="text-sm text-gray-600 mt-1">
                                    <span class="font-medium">Diterbitkan:</span> {{ $post->published_at->format('M d, Y \p\u\k\u\l H:i') }}
                                </p>
                            @endif
                        </div>
                    ...
                    <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6">
                        ...
                        @if($post->featured_image)
                            <div class="mb-4">
                                ...
                                <img src="{{ asset('storage/' . $post->featured_image) }}" alt="{{ $post->title }}" class="w-full h-32 object-cover rounded-lg">
                            </div>
                        @endif
                    ...
                    <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label for="meta_title" class="block text-sm font-medium text-gray-700">Judul Meta</label>
                                <input 
                                    type="text" 
                                    name="meta_title" 
                                    id="meta_title" 
                            ...
                            <div>
                                <label for="meta_description" class="block text-sm font-medium text-gray-700">Deskripsi Meta</label>
                                <textarea 
                                    ...
                                    placeholder="Biarkan kosong untuk menggunakan kutipan"
                    ...
                    <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6">
                        ...
                        <dl class="space-y-2 text-sm">
                            ...
                            <div>
                                ...
                                <dd class="text-gray-900">{{ $post->created_at->format('M d, Y \p\u\k\u\l H:i') }}</dd>
                            </div>
                            <div>
                                <dt class="font-medium text-gray-500">Terakhir Diubah:</dt>
                                <dd class="text-gray-900">{{ $post->updated_at->format('M d, Y \p\u\k\u\l H:i') }}</dd>
                            </div>
                        </dl>
                    </div>
                </div>
