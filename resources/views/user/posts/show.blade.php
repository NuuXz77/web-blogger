        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="space-y-2">
                        <form action="{{ route('user.posts.toggle-status', $post) }}" method="POST" class="w-full">
                            @csrf
                        ...
                        <form action="{{ route('user.posts.duplicate', $post) }}" method="POST" class="w-full">
                            @csrf
                            <button type="submit" class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                                Duplikat Postingan
                            </button>
                        ...
                        <form action="{{ route('user.posts.destroy', $post) }}" method="POST" class="w-full"
