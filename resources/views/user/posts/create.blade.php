    ...
    <x-slot:header>
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600 mt-1">Tambah informasi artikel.</p>
            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="slug" id="slug" value="{{ old('slug') }}"
                                        ...
                                        placeholder="dibuat-otomatis-dari-judul" required>
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea name="excerpt" id="excerpt" rows="3"
                                    ...
                                    placeholder="Tulis ringkasan menarik yang akan memikat pembaca untuk mengklik dan membaca lebih lanjut...">{{ old('excerpt') }}</textarea>
                                <div class="absolute top-3 right-3">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="space-y-6">
                    <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <select name="category_id" id="category_id_sidebar"
                    ...
                    <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6">
                        ...
                        <div>
                            ...
                            <div
                                class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-primary transition duration-200">
